...
lmp3<-lmPerm::lmp(recind~IceCases,data=eveK2,perm="Prob",center=T,singular.ok = F)
...
lmp4<-lmPerm::lmp(recind~TempCases,data=eveK2,perm="Prob",center=T,singular.ok = F)
