...
plot(mc1,invisible=c("var","quali.sup"),cex=.5,label="none")
plot(mc1,hab="quali")
...
write.csv(varcoord,"varcoord.csv")



euclid<-read.csv("euclid.csv")

euclid$imp<-1/euclid$Value

ggplot(subset(euclid,KRI=="High"),aes(reorder(Distance.to,+imp),
              imp))+geom_bar(position="identity",stat="identity")+
  coord_flip()+
  theme_bw()+ xlab("Variable")+ylab("Proximity")+
  ggtitle(label="a. Proximity to high KRI")+


ggplot(subset(euclid,KRI=="Low"),aes(reorder(Distance.to,+imp),
                                      imp))+geom_bar(position="identity",stat="identity")+
  coord_flip()+
  theme_bw()+ xlab("Variable")+ylab("Proximity")+
  ggtitle(label="b. Proximity to low KRI")
